...
We can check this by opening up our Font Book application on our Macs. To do this, press ⌘ + space and type "Font Book", and it should appear. We can then double check that these fonts appear:
...
Now, we can run the following code in R to rebook our fonts and make sure all of our system fonts (from Font Book) are imported into R.
